...
public class EnchereDAOJdbcImpl implements EnchereDAO {
	...
	private static final String SELECT_BY_ID = "SELECT * from ENCHERES e\n" +
			...
			"INNER JOIN UTILISATEURS u ON u.no_utilisateur = e.no_utilisateur\n"+
			" where e.no_article =?";
	private static final String SELECT_ENCHERES_BY_CATEGORIE = "SELECT * from ENCHERES e INNER JOIN ARTICLES_VENDUS a ON e.no_article = a.no_article "
			+ "INNER JOIN UTILISATEURS u ON u.no_utilisateur = e.no_utilisateur where a.no_categorie = ?";
	...
	public List<Enchere> selectByFilter(String fitler) throws BusinessException {
		...
		try (Connection cnx = ConnectionProvider.getConnection()) {
			pstmt = cnx.prepareStatement(EnchereDAOJdbcImpl.SELECT_BY_FILTER);
	...
	public List<Enchere> selectByEnchereOuverte() throws BusinessException {
		...
		try (Connection cnx = ConnectionProvider.getConnection()) {
			pstmt = cnx.prepareStatement(EnchereDAOJdbcImpl.SELECT_ENCHERES_OUVERTES);
			rs = pstmt.executeQuery();
	...
	public List<Enchere> selectEncheresEnCours(int idUser) throws BusinessException{
		...
		try (Connection cnx = ConnectionProvider.getConnection()) {
			pstmt = cnx.prepareStatement(EnchereDAOJdbcImpl.SELECT_ENCHERES_EN_COURS_BY_ID_USER);
	...
	public List<Enchere> selectEncheresRemportees(int idUtilisateur) throws BusinessException {
		...
		try (Connection cnx = ConnectionProvider.getConnection()) {
			pstmt = cnx.prepareStatement(EnchereDAOJdbcImpl.SELECT_ENCHERES_REMPORTEES);

...
<form class="filtersContainer"  method="post"
	...
	<div class="inptSlct input-group mt-4">
		<label id="selectCat" class="form-label" for="selectCat">Catégorie :</label>
		<select class="form-control col-md-2 " name="selectCat"
	...
	<div class="containerFilterCo">
		...
		<div class="chexkBoxContainer">
			...
			<div class="subContainerCB">
				...
				<div class="form-check">
					<input class="form-check-input" type="checkbox" value="encheresRemportees" name="encheresRemportees"
